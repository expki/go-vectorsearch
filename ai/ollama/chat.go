...
func (ai *Ollama) Chat(ctx context.Context, request aicomms.ChatRequest) (response aicomms.ChatResponse, err error) {
...
func (ai *Ollama) ChatStream(ctx context.Context, request aicomms.ChatRequest) (stream io.ReadCloser) {
	if request.Options == nil {
		request.Options = map[string]any{
			"num_ctx": ai.chat.Cfg.NumCtx,
		}
